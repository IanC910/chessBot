...
namespace BoardAnalyzerTests {
    ...
    TEST_CLASS(PinDirectionTests) {
        ...
        TEST_METHOD(pinDirectionTest) {
            ...
            boardAnalyzer.setBoard(board);
            Assert::IsTrue(
                boardAnalyzer.getPinDirection(Vector(1, 1))
                .equals(Vector(1, 1))
            );
            ...
            boardAnalyzer.setBoard(board);
            Assert::IsTrue(
                boardAnalyzer.getPinDirection(Vector(7, 6))
                .equals(Vector(0, -1))
            );
            ...
            boardAnalyzer.setBoard(board);
            Assert::IsTrue(
                boardAnalyzer.getPinDirection(Vector(5, 5))
                .equals(Vector(0, 0))
            );
            ...
            boardAnalyzer.setBoard(board);
            Assert::IsTrue(
                boardAnalyzer.getPinDirection(Vector(6, 3))
                .equals(Vector(0, 0))
            );
    ...
    TEST_CLASS(SquaresSeenTests) {
        ...
        TEST_METHOD(getSquaresSeenByPawnTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(squaresSeen, Vector(3, 6));
            ...
            boardAnalyzer.getSquaresSeenByPiece(squaresSeen, Vector(4, 7));
        ...
        TEST_METHOD(getSquaresSeenByBishopTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(squaresSeen, Vector(0, 0));
            Assert::IsTrue(7 == squaresSeen.size());

            board.clear();
            board.setPiece(4, 4, Piece(WHITE, BISHOP));
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(squaresSeen, Vector(4, 4));
        ...
        TEST_METHOD(getSquaresSeenByKnightTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(squaresSeen, Vector(3, 3));
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(squaresSeen, Vector(0, 2));
        ...
        TEST_METHOD(getSquaresSeenByRookTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(squaresSeen, Vector(4, 5));
            Assert::IsTrue(14 == squaresSeen.size());
        ...
        TEST_METHOD(getSquaresSeenByKingTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(targetedSqaures, Vector(3, 3));
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(targetedSqaures, Vector(2, 7));
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getSquaresSeenByPiece(targetedSqaures, Vector(7, 0));
        ...
        TEST_METHOD(getNumChecksTest) {
            ...
            board.setPiece(0, 0, Piece(WHITE, KING));
            boardAnalyzer.setBoard(board);
            Assert::IsTrue(0 == boardAnalyzer.getNumChecks(WHITE));
            Assert::IsTrue(0 == boardAnalyzer.getNumChecks(BLACK));
            ...
            boardAnalyzer.setBoard(board);
            Assert::IsTrue(1 == boardAnalyzer.getNumChecks(WHITE));
            ...
            boardAnalyzer.setBoard(board);
            Assert::IsTrue(2 == boardAnalyzer.getNumChecks(WHITE));
    ...
    TEST_CLASS(MoveAvailabilityTests) {
        ...
        TEST_METHOD(getPawnMovesTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, whitePawnPos);
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {4, 4});
            Assert::IsTrue(1 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {3, 4});
            Assert::IsTrue(0 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {2, 3});
            Assert::IsTrue(1 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {3, 3});
            Assert::IsTrue(1 == moves.size());
        }
        ...
        TEST_METHOD(getBishopMovesTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {0, 0});
            ...
            board.setPiece(1, 2, Piece(BLACK, QUEEN));
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {1, 4});
            Assert::IsTrue(1 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {4, 7});
            Assert::IsTrue(0 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {1, 0});
            Assert::IsTrue(0 == moves.size());
        }
        ...
        TEST_METHOD(getKnightMovesTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {5, 6});
            Assert::IsTrue(1 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {6, 4});
            Assert::IsTrue(2 == moves.size());
        }
        ...
        TEST_METHOD(getRookMovesTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {5, 5});
            Assert::IsTrue(1 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {5, 2});
            Assert::IsTrue(0 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {5, 7});
            Assert::IsTrue(1 == moves.size());
        }
        ...
        TEST_METHOD(startingMovesTest) {
            ...
            board.reset();
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getAllMoves(moves, WHITE);
            Assert::IsTrue(20 == moves.size());
            boardAnalyzer.getAllMoves(moves, BLACK);
            Assert::IsTrue(20 == moves.size());
        }
        ...
        TEST_METHOD(enPassantTest) {
            ...
            boardAnalyzer.getMovesForPiece(moves, {4, 5});
            Assert::IsTrue(1 == moves.size());
            boardAnalyzer.getMovesForPiece(moves, {6, 4});
            Assert::IsTrue(2 == moves.size());
        ...
        TEST_METHOD(castleAvailabilityTest) {
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {0, 4});
            Assert::IsTrue(7 == moves.size());
            ...
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {7, 4});
            Assert::IsTrue(7 == moves.size());

            // Black king moves, can no longer castle
            board.doMove(Move({7, 4}, {7, 3}, Piece(BLACK, KING)));
            boardAnalyzer.setBoard(board);
            boardAnalyzer.getMovesForPiece(moves, {7, 3});
            Assert::IsTrue(5 == moves.size());
        }
